...
// app/dashboard/criar-pedido/_client.tsx
// Wrapper client: fornece o contexto e mantém o layout original da página
...
// ─── botões de ação mobile/bottom bar (lê do contexto) ───────────────────────
...
// ─── layout da página (idêntico ao original) ─────────────────────────────────
  ...
  return (
    <div className="pt-6 px-8 lg:px-16 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        {/* Sidebar de resumo (reactivo em tempo real) */}
